...
func NewStatusHandlers(gameserverSvc *gameserver.GameserverService, querySvc *service.QueryService, workerSvc *orchestrator.WorkerNodeService, cfg config.Config, log *slog.Logger) *StatusHandlers {
